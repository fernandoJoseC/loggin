...
import com.example.login_firebase.databinding.ActivityTwitterBinding
...
class Twitter : AppCompatActivity() {
    ...
    private lateinit var views: ActivityTwitterBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        views = ActivityTwitterBinding.inflate(layoutInflater)
    ...
    private fun openDetailsActivity() {
        val myIntent = Intent(baseContext, MainActivityTwitter::class.java)
